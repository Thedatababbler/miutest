#!/bin/bash
config_file=configs/glip_Swin_T_O365_GoldG_bbone.yaml
odinw_configs=configs/glip_Swin_T_O365_GoldG_bbone.yaml
output_dir=OUTPUTS/polyp/hybrid/zero_shot/bbone/llm/top1
model_checkpoint=MODEL/glip_tiny_model_o365_goldg.pth
jsonFile=autoprompt_json/llm_bbone_path_prompt_top1.json
