#!/bin/bash
config_file=configs/glip_Swin_T_O365_GoldG_busi.yaml
odinw_configs=configs/glip_Swin_T_O365_GoldG_busi.yaml
output_dir=OUTPUTS/busi_mal/zero_shot/llm/top3
model_checkpoint=MODEL/glip_tiny_model_o365_goldg.pth
jsonFile=autoprompt_json/llm_busi_path_prompt_top3.json
