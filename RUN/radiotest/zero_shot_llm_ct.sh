#!/bin/bash
config_file=configs/glip_Swin_T_O365_GoldG_ct_liver.yaml
odinw_configs=configs/glip_Swin_T_O365_GoldG_ct_liver.yaml
output_dir=OUTPUTS/ct_liver/zero_shot/llm/top1
model_checkpoint=MODEL/glip_tiny_model_o365_goldg.pth
jsonFile=autoprompt_json/llm_ct_liver_path_prompt_top1.json
