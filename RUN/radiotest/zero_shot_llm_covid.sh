#!/bin/bash
config_file=configs/glip_Swin_T_O365_GoldG_covid.yaml
odinw_configs=configs/glip_Swin_T_O365_GoldG_covid.yaml
output_dir=OUTPUTS/covid/zero_shot/llm/top3
model_checkpoint=MODEL/glip_tiny_model_o365_goldg.pth
jsonFile=autoprompt_json/llm_covid_path_prompt_top3.json
